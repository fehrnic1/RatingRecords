...
<form method="POST" action="?/update">
    ...
    <div class="mb-3">
        <label class="form-lable" for="">Runtime</label>
        <input
            value={data.record.runtime}
            name="runtime"
            class="form-control"
            type="text"
        />
    ...
    <div class="mb-3">
        <label class="form-lable" for="">Year</label>
        <input
            value={data.record.year}
            name="year"
            class="form-control"
            type="text"
        />
    ...
    <div class="mb-3">
        <label class="form-lable" for="">Genre</label>
        <input
            value={data.record.genre}
            name="genre"
            class="form-control"
            type="text"
        />
